...
template <class T>
void getVector( ResultSet *rs, unsigned int index, OCCI_STD_NAMESPACE::vector<Ref<T> >
                &vect) 
{
  OCCI_STD_NAMESPACE::vector<void *> vec_ref;
  getVector(rs, index, vec_ref, OCCIREF);
...
template <class T>
void setVector( Statement *stmt, unsigned int index, const OCCI_STD_NAMESPACE::vector<T *>
                &vect, const OCCI_STD_NAMESPACE::string &sqltype) 
{
  OCCI_STD_NAMESPACE::vector<PObject *> vec_pobj;
  ...
  setVector(stmt, index, vec_pobj, sqltype);
}
...
void setVector( Statement *stmt, unsigned int index, const OCCI_STD_NAMESPACE::vector<Ref<T> > &vect, const OCCI_STD_NAMESPACE::string &sqltype)
{
  ...
  setVector(stmt, index, vec_ref, vec_ind, sqltype);
}
...
template <class T>
void getVector( Statement *stmt, unsigned int index, OCCI_STD_NAMESPACE::vector<Ref<T> >
                &vect) 
{
  OCCI_STD_NAMESPACE::vector<void *> vec_ref;
  getVector(stmt, index, vec_ref, OCCIREF);
