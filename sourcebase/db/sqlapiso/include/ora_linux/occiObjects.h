...
/************* get and set vector of anydata (templated functions)  **********/
...
*/
 ...
 template <class T>
 void getVector(AnyData &any, OCCI_STD_NAMESPACE::vector<T*> &vect) 
 {
   OCCI_STD_NAMESPACE::vector< PObject *> vec_pobj;
   getVector( any, vec_pobj, OCCIPOBJECT);
 ...
 template <class T>
 void getVector(AnyData &any, OCCI_STD_NAMESPACE::vector< Ref<T> > &vect) 
 
 {
   OCCI_STD_NAMESPACE::vector< void *> vec_ref;
   getVector( any, vec_ref, OCCIREF);
