...
#ifdef HPUX
#define OCCI_STD_NAMESPACE
#undef  OCCI_HAVE_STD_NAMESPACE
#else
...
/*---------------------------------------------------------------------------
  ...
  void getVector( const AnyData &any, OCCI_STD_NAMESPACE::vector<void *> &vect,  	Type typ ) ;
  template <class T>
  void getVector( const AnyData &any, OCCI_STD_NAMESPACE::vector< T* > &vect) ;
  void getVector( const AnyData &any, OCCI_STD_NAMESPACE::vector< PObject* > &vect, Type typ) ;
  ...
  void setVector( AnyData &any, const OCCI_STD_NAMESPACE::vector<void *> &vect, 
  const OCCI_STD_NAMESPACE::vector< OCIInd> &vec_ind) ;
  template <class T>
  void setVector( AnyData &any, const OCCI_STD_NAMESPACE::vector< T* > &vect) ;
  void setVector( AnyData &any, const OCCI_STD_NAMESPACE::vector< PObject* > &vect) ;
  ...
  void getVector(ResultSet  *rs, unsigned int,
  OCCI_STD_NAMESPACE::vector<void *> &vect, Type typ) ;
 ...
 const OCCI_STD_NAMESPACE::string &sqltype);
  ...
  const OCCI_STD_NAMESPACE::string &sqltype) ;
  void setVector( Statement *stmt, unsigned int paramIndex, 
  const OCCI_STD_NAMESPACE::vector<PObject *> &vect, const OCCI_STD_NAMESPACE::string &sqltype) ;
  template <class T>
  void setVector( Statement *stmt, unsigned int paramIndex, 
  const OCCI_STD_NAMESPACE::vector<T *> &vect, const OCCI_STD_NAMESPACE::string &sqltype) ;
  void setVector(Statement *stmt, unsigned int paramIndex,
  const  OCCI_STD_NAMESPACE::vector<void *> &vect, const OCCI_STD_NAMESPACE::vector<OCIInd> &vecind, const OCCI_STD_NAMESPACE::string &sqltype) ;
