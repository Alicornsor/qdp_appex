...
CServiceSkeleton::CServiceSkeleton(CReactor *pReactor, DWORD nServerID, int nMaxSession,CSelectReactor* pConnReactor)
...
CFibServerApi *CFibServerApi::CreateServerApi(CReactor *pReactor, DWORD nServerID, int nMaxSession,CSelectReactor* pConnReactor)
{
	return new CServiceSkeleton(pReactor, nServerID, nMaxSession,pConnReactor);
}
