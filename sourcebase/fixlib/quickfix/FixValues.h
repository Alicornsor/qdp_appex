...
namespace FIX
{
  ...
  const char MsgType_AvailableAccountRequest[] = "RA";
  const char MsgType_AvailableAccountRequestAck[] = "PA";
  const char MsgType_RequestForMargin[] = "RM";
  const char MsgType_RequestForMarginAck[] = "PM";
  const char MsgType_RequestForPosition[] = "RP";
  const char MsgType_RequestForPositionAck[] = "PP";
  const char MsgType_AccountDataRequest[] = "RD";
  const char MsgType_AccountDataRequesAck[] = "PD";
  const char MsgType_RequestForFee[] = "RF";
  const char MsgType_RequestForFeeAck[] = "PF";
  const char MsgType_OrderListRequest[] = "ROL";
  const char MsgType_OrderList[] = "POL";
  const char MsgType_FillOrderListRequest[] = "RFL";
  const char MsgType_FillOrderList[] = "PFL";
  ...
  const char MsgType_SecurityExchangeDefinitionRequest[] = "RE";
  const char MsgType_SecurityExchangeDefinition[] = "PE";
  ...
  const char OrdStatus_INSERTSUBMITTED = 'F';
  const char OrdStatus_CANCELSUBMITTED = 'G';
  const char OrdStatus_UNKNOWN_STATUS = 'U';
  ...
  const int CxlRejReason_TOO_LATE_TO_ENTER = 4;
  const int CxlRejReason_DUPLICATE_ORDER = 6;
  const int CxlRejReason_DUPLICATE_OF_A_VERBALLY_COMMUNICATED_ORDER = 7;
  const int CxlRejReason_STALE_ORDER = 8;
  const int CxlRejReason_INSUFFICIENT_MARGIN = 9;
  const int CxlRejReason_DUPLICATE_CLORDERID = 10;
  const int CxlRejReason_ORDER_RATE_HAS_EXCEEDED = 11;
  const int CxlRejReason_UNKOWN_CODE = 12;
  ...
  const int OrdRejReason_INSUFFICIENT_MARGIN = 9;
  const int OrdRejReason_DUPLICATE_CLORDERID = 10;
  const int OrdRejReason_ORDER_RATE_HAS_EXCEEDED = 11;
  const int OrdRejReason_UNKOWN_CODE = 12;
  ...
  const char SecurityType_MLEG[] = "MLEG";
  const char SecurityType_EQUITY[] = "EQUITY";
  ...
  const char ManualOrderIndicator_NO = 'N';
  const char ManualOrderIndicator_YES = 'Y';
  const char HedgeFlag_SPECULATION = '1';
  const char HedgeFlag_ARBITRAGE = '2';
  const char HedgeFlag_HEDGE = '3';
  const char HedgeFlag_MARKETMAKER = '4';
  const char SecurityRefStatus_BeforeTrading = '0';
  const char SecurityRefStatus_NoTrading = '1';
  const char SecurityRefStatus_Continous = '2';
  const char SecurityRefStatus_AuctionOrdering = '3';
  const char SecurityRefStatus_AuctionBalance = '4';
  const char SecurityRefStatus_AuctionMatch = '5';
  const char SecurityRefStatus_Closed = '6';
  const char PositionType_Unknown = '0';
  const char PositionType_Net = '1';
  const char PositionType_Gross = '2';
  const char OptionsType_NotOptions = '0';
  const char OptionsType_CallOptions = '1';
  const char OptionsType_PutOptions = '2';
  const char ProductClass_Unknown = '0';
  const char ProductClass_Futures = '1';
  const char ProductClass_Options = '2';
  const char ProductClass_Combination = '3';
  const char ProductClass_Spot = '4';
  const char ProductClass_EFP = '5';
  const char ProductClass_Stocks = '7';
  const char ProductClass_StockOptions = '8';
  const char OptionsMode_NullOptions = '0';
  const char OptionsMode_EuOptions = 'E';
  const char OptionsMode_AmOptions = 'A';
  const char Aggressive_NO = 'N';
  const char Aggressive_YES = 'Y';
  const char IncludeBalanceGrp_NO = 'N';
  const char IncludeBalanceGrp_YES = 'Y';
  const char OteBidAsk_NO = 'N';
  const char OteBidAsk_YES = 'Y';
  const char NovBidAsk_NO = 'N';
  const char NovBidAsk_YES = 'Y';
  const char MarginEnabled_NO = 'N';
  const char MarginEnabled_YES = 'Y';
  const char ViewOnly_NO = 'N';
  const char ViewOnly_YES = 'Y';
  const char OrderCheckMark_NO = 'N';
  const char OrderCheckMark_YES = 'Y';
