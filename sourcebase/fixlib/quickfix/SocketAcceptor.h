...
class CSocketAcceptorCB
{
public:
	virtual void onStart(){}
	virtual void onStop(){}
	virtual void onConnect( ){}
	virtual void onDisconnect( Session* pSession ){}
};
...
public:
  ...
  SocketAcceptor( Application&, MessageStoreFactory&,
                  const SessionSettings&, LogFactory&, LogFactory& ) throw( ConfigError );
  void RegisterCB(CSocketAcceptorCB *pSocketAcceptorCB)
  {
	m_pSocketAcceptorCB = pSocketAcceptorCB;
  }
...
private:
  ...
  CSocketAcceptorCB *m_pSocketAcceptorCB;
