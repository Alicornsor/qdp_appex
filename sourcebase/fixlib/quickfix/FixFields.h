...
namespace FIX
{
  ...
  DEFINE_INT(FixClientSessionID);
  DEFINE_CHAR(HedgeFlag);
  DEFINE_FLOAT(LongMarginRate);
  DEFINE_FLOAT(LongMarginAmt);
  DEFINE_FLOAT(ShortMarginRate);
  DEFINE_FLOAT(ShortMarginAmt);
  DEFINE_STRING(ParticipantID);
  DEFINE_FLOAT(UsedMargin);
  DEFINE_INT(TotalPosition);
  DEFINE_FLOAT(PositionCost);
  DEFINE_INT(YdPosition);
  DEFINE_FLOAT(YdPositionCost);
  DEFINE_FLOAT(FrozenMargin);
  DEFINE_INT(FrozenPosition);
  DEFINE_INT(FrozenClosing);
  DEFINE_FLOAT(FrozenPremium);
  DEFINE_STRING(LastTradeID);
  DEFINE_STRING(LastOrderLocalID);
  DEFINE_FLOAT(PositionProfit);
  DEFINE_INT(TodayPosition);
  DEFINE_INT(FrozenTodayClosing);
  DEFINE_FLOAT(PreBalance);
  DEFINE_FLOAT(PreAvailable);
  DEFINE_FLOAT(Deposit);
  DEFINE_FLOAT(Withdraw);
  DEFINE_FLOAT(Margin);
  DEFINE_FLOAT(Premium);
  DEFINE_FLOAT(Fee);
  DEFINE_FLOAT(FrozenFee);
  DEFINE_FLOAT(CloseProfit);
  DEFINE_FLOAT(Available);
  DEFINE_FLOAT(Balance);
  DEFINE_FLOAT(LongMargin);
  DEFINE_FLOAT(ShortMargin);
  DEFINE_FLOAT(LongFrozenMargin);
  DEFINE_FLOAT(ShortFrozenMargin);
  DEFINE_FLOAT(DynamicRights);
  DEFINE_FLOAT(Risk);
  DEFINE_FLOAT(OtherFee);
  DEFINE_FLOAT(Mortgage);
  DEFINE_FLOAT(OpenFeeRate);
  DEFINE_FLOAT(OpenFeeAmt);
  DEFINE_FLOAT(OffsetFeeRate);
  DEFINE_FLOAT(OffsetFeeAmt);
  DEFINE_FLOAT(OTFeeRate);
  DEFINE_FLOAT(OTFeeAmt);
  DEFINE_STRING(SymbolRef);
  DEFINE_INT(DeliveryYear);
  DEFINE_INT(DeliveryMonth);
  DEFINE_INT(MaxLimitOrderVolume);
  DEFINE_INT(MinLimitOrderVolume);
  DEFINE_INT(MaxMarketOrderVolume);
  DEFINE_INT(MinMarketOrderVolume);
  DEFINE_INT(VolumeMultiple);
  DEFINE_FLOAT(PriceTick);
  DEFINE_INT(LongPosLimit);
  DEFINE_INT(ShortPosLimit);
  DEFINE_FLOAT(LowerLimitPrice);
  DEFINE_FLOAT(UpperLimitPrice);
  DEFINE_FLOAT(PreSettlementPrice);
  DEFINE_CHAR(SecurityRefStatus);
  DEFINE_STRING(CreateDate);
  DEFINE_STRING(OpenDate);
  DEFINE_STRING(StartDelivDate);
  DEFINE_STRING(EndDelivDate);
  DEFINE_FLOAT(BasisPrice);
  DEFINE_INT(IsTrading);
  DEFINE_STRING(UnderlyingInstrID);
  DEFINE_INT(UnderlyingMultiple);
  DEFINE_CHAR(PositionType);
  DEFINE_CHAR(OptionsType);
  DEFINE_CHAR(ProductClass);
  DEFINE_CHAR(OptionsMode);
  DEFINE_STRING(SecurityRef);
  DEFINE_STRING(SecurityExchangeRef);
  DEFINE_STRING(OrderCancelTime);
  DEFINE_STRING(CancelAccountID);
  DEFINE_STRING(SeatID);
  DEFINE_BOOLEAN(Aggressive);
  DEFINE_STRING(AcctReqID);
  DEFINE_QTY(TriggerQty);
  DEFINE_STRING(AccountName);
  DEFINE_STRING(AsOfDate);
  DEFINE_AMT(CashExcess);
  DEFINE_AMT(CollateralOnDeposit);
  DEFINE_STRING(FCMAccountNumber);
  DEFINE_AMT(InitialMarginReqs);
  DEFINE_AMT(MaintenanceMarginReqs);
  DEFINE_AMT(MarketValue);
  DEFINE_AMT(OpenTradeEquity);
  DEFINE_AMT(TotalAccountValue);
  DEFINE_AMT(TotalEndingCashBalance);
  DEFINE_AMT(UnrealizedPL);
  DEFINE_INT(ReqResult);
  DEFINE_LOCALMKTDATE(StatementDate);
  DEFINE_INT(ClientRegulatoryAlgorithmID);
  DEFINE_STRING(OrderSource);
  DEFINE_STRING(ChainOrderID);
  DEFINE_BOOLEAN(IncludeBalanceGrp);
  DEFINE_STRING(RequestID);
  DEFINE_STRING(RevisionTag);
  DEFINE_STRING(CQGListID);
  DEFINE_INT(NoAllowedInstr);
  DEFINE_INT(NoEnablements);
  DEFINE_INT(EnablementID);
  DEFINE_INT(EnablementGroup);
  DEFINE_INT(BillingGroupID);
  DEFINE_INT(BillingID);
  DEFINE_AMT(TotalMarginReqs);
  DEFINE_AMT(PurchasingPower);
  DEFINE_CHAR(OteInPurchasingPower);
  DEFINE_CHAR(NovInPurchasingPower);
  DEFINE_BOOLEAN(OteBidAsk);
  DEFINE_BOOLEAN(NovBidAsk);
  DEFINE_STRING(UserStrategyType);
  DEFINE_INT(FCMID);
  DEFINE_INT(NoRates);
  DEFINE_CURRENCY(MasterCurrency);
  DEFINE_PRICE(CurrencyRate);
  DEFINE_BOOLEAN(MarginEnabled);
  DEFINE_INT(NoAccounts);
  DEFINE_STRING(FCMName);
  DEFINE_BOOLEAN(ViewOnly);
  DEFINE_INT(NoBalances);
  DEFINE_STRING(SalesSeriesNumber);
  DEFINE_CURRENCY(BalanceCurrency);
  DEFINE_AMT(BalanceEndingCashBalance);
  DEFINE_AMT(BalanceTotalAccountValue);
  DEFINE_AMT(BalanceOpenTradeEquity);
  DEFINE_AMT(BalanceUnrealizedPL);
  DEFINE_AMT(BalanceMarketValue);
  DEFINE_AMT(BalanceCashExcess);
  DEFINE_AMT(BalanceCollateralOnDeposit);
  DEFINE_AMT(BalanceInitialMarginReqs);
  DEFINE_AMT(BalanceMaintenanceMarginReqs);
  DEFINE_STRING(NestedListID);
  DEFINE_STRING(NestedCQGListID);
  DEFINE_LOCALMKTDATE(OrderPlacementTime);
  DEFINE_STRING(LastModifierUsername);
  DEFINE_BOOLEAN(OrderCheckMark);
  DEFINE_STRING(ExchangeKeyID);
  DEFINE_STRING(FillExecID);
  DEFINE_AMT(RealizedPL);
  DEFINE_INT(LegNumber);
  DEFINE_STRING(UnderlyingExDestination);
  DEFINE_STRING(UnderlyingExchangeKeyID);
  DEFINE_STRING(Unknow);
  DEFINE_STRING(CFICode);
  DEFINE_STRING(UnderlyingCFICode);
  DEFINE_STRING(SecondaryClOrderID);
