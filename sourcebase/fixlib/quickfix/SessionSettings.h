...
const char SERVERID[] = "ServerID";
const char PASSWORD[] = "Password";
const char ApplicationSystemName[] = "ApplicationSystemName";
const char TradingSystemVersion[] = "TradingSystemVersion";
const char ApplicationSystemVendor[] = "ApplicationSystemVendor";
const char Sender_SubID[] = "SenderSubID";
const char Sender_LocationID[] = "SenderLocationID";
const char Target_SubID[] = "TargetSubID";
const char Auto_SendLogon[] = "AutoSendLogon";
...
public:
  ...
  SessionSettings( Settings &settings ) throw( ConfigError );
