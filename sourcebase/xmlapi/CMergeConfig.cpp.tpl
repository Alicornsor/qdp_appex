...
///@file CMergeConfig.cpp                                                         
///@brief实现了与MergeConfig XML配置文件操作有关的类接口                                     
///@history                                                              
///20051025	陈钧雷		创建该文件                                         
/////////////////////////////////////////////////////////////////////////
#include "public.h"
//#pragma warning(disable:4786)
#include "CMergeConfig.h"
#include "CXML.h"
#include <typeinfo>
...
bool C!!@name!!::ReadXML()
{
	...
	try{
#ifdef WIN32
	pDoc->read(".\\MergeConfig.xml");
#else
	pDoc->read("./MergeConfigxml");
#endif
	}
...
bool C!!@name!!::WriteXML()
{
	...
	pDoc->setVersion("1.0");
	pDoc->setDoctype("..\\..\\config\\MergeConfig.dtd");
	pDoc->setRootNode(rootNode);
	pDoc->setRoot("MergeConfig");	
#ifdef WIN32
	pDoc->write(".\\MergeConfig.xml");
#else
	pDoc->write("./MergeConfig.xml");
#endif
	delete pDoc;
