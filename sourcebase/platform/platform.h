...
///@history 
///20020214	xuzh		创建该文件
///20070912 hwp		修改UNIX宏
///20070927 hwp		修正LINUX下singal头文件
///20080603 hwp		增加WIN32下的getopt函数
///20080727 hwp		增加stack头文件
///20090119 hwp		修改GET_ACCURATE_TIME，使得UNIX和WINN下含义相同：
///						当日毫秒数（NT-0065）
/////////////////////////////////////////////////////////////////////////
...
//20130828 xuzh 增加UF_INT8的定义，用于64字节的流文件id处理
...
//时间精度为us,20130111,wangwei
//2013.08.12 longqy@cffex.net 下面在算分钟的时候，超过32位的长度溢出，必须强制转换为(long)类型
